...
public class DistributionExcellentParkingBoyTest {
    ...
    @Test
    public void should_return_null_when_call_getExcellentParkingBoy_given_parking_boy_table_is_null() {
        when(parkingBoyRepository.findAll()).thenReturn(null);
        assertNull(new DistributionExcellentParkingBoy().getExcellentParkingBoy());
    }

    @Test
    public void should_return_parking_boy_when_call_getExcellentParkingBoy_given_parking_order_table_is_null() {
        ParkingBoy parkingBoy = new ParkingBoy();
        when(parkingBoyRepository.findAll()).thenReturn(Arrays.asList(parkingBoy));
        assertNotNull(new DistributionExcellentParkingBoy().getExcellentParkingBoy());
    }
